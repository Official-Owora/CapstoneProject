    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AvailabilityDay = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AvailabilityTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AvailabilityStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AvailabilityEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_appointments_Mentor_MentorId",
                        column: x => x.MentorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mentee", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_Mentee_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Mentee_Mentor_MentorId",
                        column: x => x.MentorId,
                        principalTable: "Mentor",
                        principalColumn: "UserId");
                });
